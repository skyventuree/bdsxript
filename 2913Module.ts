// 2913Module.ts wrapper
// This script is not up-to-date with the
// original script and heavily modified for
// my other script use.
...
//
// Wrapper script by minyee2913
// https://github.com/minyee2913/bdsX-scripts
...
function ListenInvTransaction(handler = (ev: {sactiontype: number;sourceType: number;CraftingAction: number;ReleaseAction: number;UseAction: number;useOnAction: number;networkIdentifier:NetworkIdentifier; size:number}) => {}){
    nethook.raw(PacketId.InventoryTransaction).on((ptr, size, networkIdentifier)=>{
        ...
        // disable the log for this because i don't need it
...
console.log(red('[2913Module] Finish loading!'));
console.log("[2913Module] https://github.com/minyee2913/bdsX-scripts");
